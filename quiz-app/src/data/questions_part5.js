export const questionsPart5 = [
  ...
  // ===== Skills System (8 questions, IDs 263-270) =====
  {
    ...
    whyOthersWrong: {
      ...
      docStatus: "STRONG",
      skilljarRef: { course: "Anthropic Docs", lesson: "Skills", url: "https://code.claude.com/docs/en/skills" },
      docReference: {
  ...
  // ===== Context Window (4 questions, IDs 297-300) =====
  {
    ...
    whyOthersWrong: {
      ...
      docStatus: "STRONG",
      skilljarRef: { course: "Anthropic Docs", lesson: "Context window", url: "https://code.claude.com/docs/en/context-window" },
      docReference: {
  ...
  },
  {
    ...
    whyOthersWrong: {
      ...
      docStatus: "STRONG",
      skilljarRef: { course: "Claude Code in Action", lesson: "Defining hooks", url: "https://anthropic.skilljar.com/claude-code-in-action/312002" },
      docReference: {
