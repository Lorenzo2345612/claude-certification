...
// Keyword-based URL mapping — matches question text to the exact doc section
const DOC_KEYWORD_MAP = [
  ...
  // Structured outputs & extraction schemas
  ...
  // Agent SDK subagents & coordinator patterns
    ...
    <div className="app">
      <header className="app-header">
        ...
        <nav className="header-nav">
          <button
            className={`nav-tab${mode === 'learn' ? ' nav-tab--active' : ''}`}
            onClick={() => switchMode('learn')}
          >
            Learn
          </button>
          <button
            className={`nav-tab${mode === 'practice' ? ' nav-tab--active' : ''}`}
      ...
      <div className="main-content">
        {mode === 'learn' && <LearnScreen domains={DOMAINS} />}
